...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card card-primary box-solid">
                ...
                <div class="card-body no-padding">
                    <div class="card card-body bg-primary callout callout-info callout-help ">
                    ...
                    <form method="POST" action="/dashboard/pages/{{ $page->id . '/sections/content' . (isset($item)? "/{$item->id}" : '')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            @include('DH::pages.components.form_heading')
                            ...
                            @include('DH::pages.components.form_content')
    ...
    @if(isset($item))
        @include('DH::photos.photoable', ['photoable' => $item, 'photos' => $item->photos])

        @include('DH::documents.documentable', ['documentable' => $item, 'documents' => $item->documents])
    @endif
@endsection
