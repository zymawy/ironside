            ...
            <div class="card card-primary">
                <div class="card-header bg-primary with-border">
                    <h3 class="card-title text-white">
                        ...
                        <span>{{ trans('dashboard/indexes.articles')  }} - {{ $item->title }}</span>
                    </h3>
                </div>
                    ...
                    <form>
                        <fieldset>
                            <div class="row">
                                <div class="col col-6">
                                    <section class="form-group">
                                        <label>{{ trans('dashboard/forms.title') }}</label>
                            ...
                            <div class="form-group">
                                <label>{{ trans('dashboard/forms.category_summary') }}</label>
                            ...
                            <div class="row">
                                <div class="col col-4">
                                    <div class="form-group">
                                        <label>{{ trans('dashboard/forms.category') }}</label>
                            ...
                            <div class="form-group">
                                <label>
                                    {{ trans('dashboard/general.table.description') }}
                                </label>
