...
@section('content')
    ...
    @include('website.partials.navbar-website')
    <main>
        <section class="hero text-light text-center">
            <div class="container-sm">
                <div class="hero-inner">
                    <h1 class="hero-title h2-mobile mt-0 is-revealing">
                        تعلم اللغة الانجليزية بأسهل الطرق
                    </h1>
                    <p class="hero-paragraph is-revealing">
                        إن الإدراك البشري يكون مضبوطاً على ملاحظة بعض الأنماط والتكرارات ضمن النصوص، ولذلك يكون النص
                        الوهمي مؤلفاً من عددٍ أكبر من الكلمات والمقاطع العشوائية ممّا يمنع الأنماط المكرّرة التي تعرقل
                        تشكيل انطباعٍ بصري، ويسهّل عملية المقارنة بين المحارف مختلفة التصميم
                    </p>
                    <p class="hero-cta is-revealing">
                        <a class="button button-secondary button-shadow" href="/subscriptions">
                            اشترك الان
                        </a>
                    </p>
                    ...
                    <div class="features-wrap">
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                                ...
                                <p class="text-sm">
                                    أُنشئ في القرن السادس عشر، وهو مكتوب بلغةٍ شبه لاتينية ويتألف من سلسلةٍ من الكلمات
                                    اللاتينية الصحيحة
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                                ...
                                <p class="text-sm">
                                    ولكن هذا النص القديم غير مفهومٍ أيضاً وهو يقلّد إيقاع معظم اللغات الأوروبية. وتكون
                                    الفائدة الكبيرة من استعمال هذا النص عديم المعنى وذي الأصل اللاتيني
                                </p>
                            </div>
                        </div>
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                                ...
                                <p class="text-sm">
                                    هو عدم تشتيت انتباه القارئ عن التصميم ومنع انشغاله بالتركيز في النص بحد ذاته.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="features-extended-inner section-inner has-top-divider">
                    <div class="features-extended-header text-center">
                        <div class="container-sm">
                            ...
                            <p class="section-paragraph">
                                إن الإدراك البشري يكون مضبوطاً على ملاحظة بعض الأنماط والتكرارات ضمن النصوص، ولذلك يكون
                                النص الوهمي مؤلفاً من عددٍ أكبر من الكلمات
                            </p>
                        </div>
                    </div>
                    <div class="feature-extended">
                        ...
                        <div class="feature-extended-body">
                            ...
                            <p>
                                عندما يكون النص مرئيًا ، يميل الأشخاص إلى التركيز على المحتوى النصي بدلاً من التركيز على
                                العرض العام
                            </p>
                        </div>
                    </div>
        ...
        @include('website.partials.subscriptions')
    </main>
