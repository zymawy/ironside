    ...
    <div class="container">
        <div class="site-footer-inner">
            <div class="brand footer-brand">
                <a href="#">
                    <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                        <title>مشعل للغة الانجليزية</title>
                        <defs>
            ...
            <ul class="footer-social-links list-reset">
                <li>
                    <a href="#">
                        <span class="screen-reader-text">فيس بوك</span>
                ...
                <li>
                    <a href="#">
                        <span class="screen-reader-text">قوقل</span>
                        <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="footer-copyright">&copy; {{ date('Y') }} جميع الحقوق محفوظة لـمشعل </div>
        </div>
    </div>
</footer>