    ...
    <div id="chatter" class="discussion">
        ...
        <div id="chatter_header" style="background-color:{{ $discussion->color }}">
            <div class="container">
                ...
                <h1>{{ $discussion->title }}</h1><span class="chatter_head_details"> @lang('chatter::messages.discussion.head_details')
                    <a class="chatter_cat"
                            ...
                            <div class="column is-3  left-column">
                                ...
                                <div class="chatter_sidebar">
                                    <button class="btn btn-primary" id="new_discussion_btn"><i
                                                class="chatter-new"></i> @lang('chatter::messages.discussion.new')
                                    </button>
                                    <a href="/{{ Config::get('chatter.routes.home') }}"><i
                                                class="chatter-bubble"></i> @lang('chatter::messages.discussion.all')
                                    </a>
		        					...
		        					{{ strtoupper(substr(Auth::user()->{Config::get('chatter.user.database_field_with_user_name')}, 0, 1)) }}
                                            ...
                                            <form id="chatter_form_editor"
                                                ...
                                                <div id="editor">
                                                    ...
                                                    @elseif($chatter_editor == 'simplemde')
                                                        <textarea id="simplemde" name="body" class="input"
                                                                  placeholder="">{{ old('body') }}</textarea>
                                                    @elseif($chatter_editor == 'trumbowyg')
                                        ...
                                        <div id="discussion_response_email">
                                            <button id="submit_response" class="btn btn-success pull-right"><i
                                                        class="chatter-new"></i> @lang('chatter::messages.response.submit')
                                            </button>
                ...
                <div id="new_discussion_in_discussion_view">
                    ...
                    <form id="chatter_form_editor_in_discussion_view"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <!-- CATEGORY -->
                                <select id="chatter_category_id" class="input" name="chatter_category_id">
