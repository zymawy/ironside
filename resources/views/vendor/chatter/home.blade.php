        ...
        <div id="new_discussion">
            ...
            <form id="chatter_form_editor" action="/{{ Config::get('chatter.routes.home') }}/{{ Config::get('chatter.routes.discussion') }}" method="POST">
                <div class="row">
                    <div class="col-md-7">
                        <!-- TITLE -->
                        <input type="text" class="input" id="title" name="title" placeholder="@lang('chatter::messages.editor.title')" value="{{ old('title') }}" >
                    </div>
                ...
                <div id="editor">
                    ...
                    @elseif($chatter_editor == 'simplemde')
                        <textarea id="simplemde" name="body" class="input" placeholder="">{{ old('body') }}</textarea>
                    @elseif($chatter_editor == 'trumbowyg')
