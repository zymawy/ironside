...
class ClientsController extends AdminController
{
    ...
    public function index()
    {
        ...
        // if pagination ajax
        if (request()->ajax()) {
            return response()->json(view('dashboard.accounts.clients.pagination')
...
//        $this->createEntry(User::class, $attributes);
    ...
    private function fetchEntries()
    {
        ...
        $items = User::whereRoleIs(Role::$USER)->orderBy('firstname')->get();
